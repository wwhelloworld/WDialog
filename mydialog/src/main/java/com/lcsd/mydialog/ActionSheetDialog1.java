 ...
 */
public class ActionSheetDialog1 extends BottomBaseDialog<ActionSheetDialog1> {
    /** ListView */
    ...
    public ActionSheetDialog1(Context context, ArrayList<DialogMenuItem> baseItems, View animateView) {
        super(context, animateView);
        mContents.addAll(baseItems);
        init();
    }

    public ActionSheetDialog1(Context context, String[] items, View animateView) {
        super(context, animateView);
    ...
    public ActionSheetDialog1(Context context, BaseAdapter adapter, View animateView) {
        super(context, animateView);
        mAdapter = adapter;
        init();
    }
    ...
    public View onCreateView() {
        ...
        /** title underline */
        mVLineTitle = new View(context);
        ll_container.addView(mVLineTitle);

        /** listview */
        mLv = new ListView(context);
        ...
        TextView cancelDivider = new TextView(context);
        cancelDivider.setGravity(Gravity.CENTER);
        cancelDivider.setBackgroundColor(Color.parseColor("#ffefefef"));
        LayoutParams clp = new LayoutParams(LayoutParams.MATCH_PARENT, 10);//是下方与item间距
    ...
    public ActionSheetDialog1 titleBgColor(int titleBgColor) {
        mTitleBgColor = titleBgColor;
        return this;
    }

    /** set title text(设置标题内容) */
    public ActionSheetDialog1 title(String title) {
        mTitle = title;
        return this;
    }

    /** set titleHeight(设置标题高度) */
    public ActionSheetDialog1 titleHeight(float titleHeight) {
        mTitleHeight = titleHeight;
        return this;
    }

    /** set title textsize(设置标题字体大小) */
    public ActionSheetDialog1 titleTextSize_SP(float titleTextSize_SP) {
        mTitleTextSize = titleTextSize_SP;
        return this;
    }

    /** set title textcolor(设置标题字体颜色) */
    public ActionSheetDialog1 titleTextColor(int titleTextColor) {
        mTitleTextColor = titleTextColor;
        return this;
    }

    /** enable title show(设置标题是否显示) */
    public ActionSheetDialog1 isTitleShow(boolean isTitleShow) {
        mIsTitleShow = isTitleShow;
        return this;
    }

    /** set ListView background color(设置ListView背景) */
    public ActionSheetDialog1 lvBgColor(int lvBgColor) {
        mLvBgColor = lvBgColor;
        return this;
    }

    /** set corner radius(设置圆角程度,单位dp) */
    public ActionSheetDialog1 cornerRadius(float cornerRadius_DP) {
        mCornerRadius = cornerRadius_DP;
        return this;
    }

    /** set divider color(ListView divider颜色) */
    public ActionSheetDialog1 dividerColor(int dividerColor) {
        mDividerColor = dividerColor;
        return this;
    }

    /** set divider height(ListView divider高度) */
    public ActionSheetDialog1 dividerHeight(float dividerHeight_DP) {
        mDividerHeight = dividerHeight_DP;
        return this;
    }

    /** set item press color(item按住颜色) */
    public ActionSheetDialog1 itemPressColor(int itemPressColor) {
        mItemPressColor = itemPressColor;
        return this;
    }

    /** set item textcolor(item字体颜色)* @return ActionSheetDialog */
    public ActionSheetDialog1 itemTextColor(int itemTextColor) {
        mItemTextColor = itemTextColor;
        return this;
    }

    /** set item textsize(item字体大小) */
    public ActionSheetDialog1 itemTextSize(float itemTextSize_SP) {
        mItemTextSize = itemTextSize_SP;
        return this;
    }

    /** set item height(item高度) */
    public ActionSheetDialog1 itemHeight(float itemHeight_DP) {
        mItemHeight = itemHeight_DP;
        return this;
    }

    /** set layoutAnimation(设置layout动画 ,传入null将不显示layout动画) */
    public ActionSheetDialog1 layoutAnimation(LayoutAnimationController lac) {
        mLac = lac;
        return this;
    }

    /** set cancel btn text(设置取消按钮内容) */
    public ActionSheetDialog1 cancelText(String cancelText) {
        mCancelText = cancelText;
        return this;
    }

    /** cancel btn text color(取消按钮文字颜色) */
    public ActionSheetDialog1 cancelText(int cancelTextColor) {
        mCancelTextColor = cancelTextColor;
        return this;
    }

    /** cancel btn text size(取消按钮文字大小) */
    public ActionSheetDialog1 cancelTextSize(float cancelTextSize) {
    ...
    class ListDialogAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            ivItem.setImageResource(item.resId);
            tvItem.setText(item.operName);
            ivItem.setVisibility(item.resId == 0 ? View.GONE : View.VISIBLE);
